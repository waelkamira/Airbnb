...
export default function CreateListPage2({ setIsListOpen }) {
  ...
  return (
    <div
      className="flex flex-col items-start bg-white rounded-lg p-4 h-fit w-[90%] sm:w-3/4 lg:w-2/3 xl:w-1/3 z-50"
    ...
    >
      ...
      <h6 className="text-gray-400 my-2 text-center">Help guests Find You!</h6>
      <CountrySelector />
    </div>
  );
}
