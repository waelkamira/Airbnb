...
export default function RegisterPage() {
  ...
  return (
    <div className="flex justify-center items-center inset-0 bg-black/20 h-full p-4 absolute">
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="w-full md:w-2/3 xl:w-1/3 bg-white flex flex-col items-center justify-start rounded-xl p-2"
      >
        <h1 className="text-2xl font-bold p-4">Register</h1>
        ...
        <div className="p-2 w-full mb-2 cursor-pointer ">
        ...
        <Link href={'/login'}>
          ...
          <div className="flex items-center">
            <h1 className="flex peer my-2 text-gray-500 transition-all duration-300">
              ...
              <span className="text-primary hover:underline px-2"> Login</span>
            </h1>
